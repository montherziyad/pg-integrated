        ...
        return [
            ...
            [
                ...
                'sections' => [
                    ...
                    'hero' => [
                        'eyebrow' => 'Services',
                        'title' => 'Integrated services from strategy to media delivery.',
                        'body' => 'A focused selection from the credentials deck: brand strategy, identity, 360 campaigns, outdoor, internal communication, TV/video advertising, digital, activations, branding, and Media Zone support.',
                    ...
                    'items' => [
                        ...
                        ['title' => 'Outdoor Campaigns', 'body' => 'OOH and outdoor-led awareness campaigns, including megacom, mupi, bridge, retail frontage, and city visibility formats.'],
                        ['title' => 'Internal Campaigns', 'body' => 'Internal communication, employee engagement, branch communication, leadership messages, and corporate culture campaigns.'],
                        ['title' => 'TV & Video Advertising', 'body' => 'Television concepts, film scripts, campaign videos, digital cutdowns, motion, post-production, and social-first video assets.'],
                        ...
                        ['title' => 'Media Zone Services', 'body' => 'Media planning and buying support through Media Zone, covering campaign amplification, channel selection, and media execution.'],
                    ],
                ],
            ...
            [
                ...
                'sections' => [
                    ...
                    'stats' => [
                        ['value' => '135', 'label' => 'Total family members'],
                        ['value' => '77', 'label' => 'Jeddah'],
                        ['value' => '30', 'label' => 'Riyadh'],
                        ['value' => '21', 'label' => 'Cairo'],
                        ['value' => '3', 'label' => 'Dubai'],
                        ['value' => '2 + 2', 'label' => 'Beirut + Manila'],
                    ],
                    'items' => [
            ...
            [
                ...
                'sections' => [
                    ...
                    'items' => [
                        ...
                        ['name' => 'LUX / Sunlight', 'image' => '/prd-assets/Client/LUX-Sunlight.jpeg'],
                        ['name' => 'Tetra Pak', 'image' => '/prd-assets/Client/Tetra-Pack-logo-300x202.jpeg'],
                        ['name' => 'SMSA', 'image' => '/prd-assets/Client/SMSA-logo-300x202.jpeg'],
                        ['name' => 'Saptco', 'image' => '/prd-assets/Client/saptco.jpeg'],
                        ['name' => 'HRDF', 'image' => '/prd-assets/Client/HRDF-logo-250x202.jpeg'],
                        ['name' => 'MOE', 'image' => '/prd-assets/Client/MOE-logo-300x202.jpeg'],
                        ['name' => 'Nakhlatain', 'image' => '/prd-assets/Client/Nakhlatain-logo-300x202.jpeg'],
                        ['name' => 'MEP', 'image' => '/prd-assets/Client/MEP-logo-300x202.jpeg'],
                        ['name' => 'Faten', 'image' => '/prd-assets/Client/Faten-logo-250x202.jpeg'],
                        ['name' => 'ITCO', 'image' => '/prd-assets/Client/ITCO.jpeg'],
                        ['name' => 'Treva', 'image' => '/prd-assets/Client/Treva-logo-250x202.jpeg'],
                        ['name' => 'Omelac', 'image' => '/prd-assets/Client/Omelac-logo-300x202.jpeg'],
