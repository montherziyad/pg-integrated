...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE assets ADD CONSTRAINT assets_asset_stage_check CHECK (asset_stage::text = ANY (ARRAY['BRIEF','CONTENT','DESIGN','MOTION','REVIEW','EMPLOYEE_HANDOVER','CLIENT_SERVICE_REVISION','FINAL','SOURCE','ARCHIVE']))");
    }
