            ...
            <div class="pg-card">
                <div class="pg-card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div><label class="block mb-2 font-semibold">Company Email Domain</label><input name="outlook_company_domain" value="{{ old('outlook_company_domain', $settings['outlook_company_domain']) }}" class="w-full rounded-xl border-slate-300" required></div>
