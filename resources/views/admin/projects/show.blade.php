...
<div><div class="pg-stat-label">Client Service</div><div class="font-semibold">{{ $project->client?->clientServiceNames() ?? '-' }}</div></div>
<div><div class="pg-stat-label">Project Manager</div><div class="font-semibold">{{ $project->projectManager?->name ?? '-' }}</div></div>
