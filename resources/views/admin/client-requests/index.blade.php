    ...
    <div class="overflow-hidden rounded-2xl bg-white shadow">
        <table class="w-full text-left text-sm">
            <thead class="bg-slate-50 text-slate-500">
                <tr><th class="p-4">Request</th><th>Client</th><th>Project</th><th>Type</th><th>Status</th><th></th></tr>
            </thead>
            <tbody>
            ...
            @empty
                <tr><td colspan="6" class="p-8 text-center text-slate-500">No client requests yet.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
