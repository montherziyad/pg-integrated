    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-72 bg-slate-950 text-white flex flex-col">
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.events.index') }}" class="block px-4 py-3 rounded-xl {{ request()->routeIs('admin.events.*') ? 'bg-slate-800 text-white font-medium' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">الفعاليات</a>
            </nav>
